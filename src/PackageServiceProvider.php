<?php
namespace ProcessMaker\Package\PpsFoxleyInventory;

use Illuminate\Support\Facades\Route;
use Illuminate\Support\ServiceProvider;
use ProcessMaker\Package\Packages\Events\PackageEvent;
use ProcessMaker\Package\PpsFoxleyInventory\Http\Middleware\AddToMenus;
use ProcessMaker\Package\PpsFoxleyInventory\Listeners\PackageListener;

class PackageServiceProvider extends ServiceProvider
{

    // Assign the default namespace for our controllers
    protected $namespace = '\ProcessMaker\Package\PpsFoxleyInventory\Http\Controllers';
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . '/../resources/views/', 'pps-foxley-inventory');

        $this->publishes([
            __DIR__.'/../public' => public_path('vendor/processmaker/packages/pps-foxley-inventory'),
        ], 'pps-foxley-inventory');
