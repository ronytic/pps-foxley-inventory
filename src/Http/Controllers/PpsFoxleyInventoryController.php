...
namespace ProcessMaker\Package\PpsFoxleyInventory\Http\Controllers;

use ProcessMaker\Http\Controllers\Controller;
use ProcessMaker\Http\Resources\ApiCollection;
use ProcessMaker\Package\PpsFoxleyInventory\Models\Sample;
use RBAC;
use Illuminate\Http\Request;
use URL;


class PpsFoxleyInventoryController extends Controller
{
