...
searchDirectoryFiles(getcwd() . '/', 'pps-foxley-inventory', $argv[1]);

searchDirectoryFiles(getcwd() . '/', 'PpsFoxleyInventory', dashesToCamelCase($argv[1], true));

searchDirectoryFiles(getcwd() . '/', 'Pps Foxley Inventory', dashesToCamelCase($argv[1], true, ' '));
