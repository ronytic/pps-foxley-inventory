...
@endsection
@section('css')
    <link rel="stylesheet" href="{{mix('/css/package.css', 'vendor/processmaker/packages/pps-foxley-inventory')}}">
@endsection
@section('content')
    <div class="container page-content" id="app-pps-foxley-inventory">
        <p class="lead">
        <h1>{{__('Samples')}}</h1>
        <div class="row">
            <div class="col">
...
@section('js')
<script src="{{mix('/js/package.js', 'vendor/processmaker/packages/pps-foxley-inventory')}}"></script>
@endsection
@endsection
