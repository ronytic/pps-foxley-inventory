    ...
    methods: {
        ...
        onSubmit (evt) {
            ...
            if (this.validateForm()) {
                ...
                if (this.action === "Add") {
                    ProcessMaker.apiClient.post("admin/pps-foxley-inventory", {
                    ...
                    ProcessMaker.apiClient.patch(`admin/pps-foxley-inventory/${this.sample.id}`, {
                        name: this.sample.name,
                        status: this.sample.status
                    })
                        .then((response) => {
